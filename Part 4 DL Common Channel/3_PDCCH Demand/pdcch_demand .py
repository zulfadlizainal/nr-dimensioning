...
df_agg_level['RE/Frame_Data'] = df_agg_level['CCE Agg Level'] * \
    data_scheduled_number*6*12
df_agg_level['RE/Frame_VoNR'] = df_agg_level['CCE Agg Level'] * \
    voice_scheduled_number*6*12
df_agg_level['RE/Frame_Total'] = df_agg_level['RE/Frame_Data'] + \
    df_agg_level['RE/Frame_VoNR']
...
df_agg_level[['RE/Frame_Data', 'RE/Frame_VoNR']
             ].plot(kind='bar', stacked=True, width=1)
plt.title(
