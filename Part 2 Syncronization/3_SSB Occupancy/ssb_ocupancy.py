...
notx_size = (9*1) + (8*1) + (57*1) + (56*1)
ssb_size = pss_size + sss_size + pbch_size + notx_size
            ...
            if i < len(p):
                ...
                if l <= 8:
                    ...
                    df_fr1[f'L = {l}, p = {p[i]} ms'] = (
                        ((ssb_size)*l*(np.floor(sec/p[i])))/df_fr1['Normal CP RE/Sec'])*100
            ...
            if i < len(p):
                ...
                if l <= 64:
                    ...
                    df_fr2[f'L = {l}, p = {p[i]} ms'] = (
                        ((ssb_size)*l*(np.floor(sec/p[i])))/df_fr2['Normal CP RE/Sec'])*100
...
df_fr1_scs15_5ms.plot(kind='line', style='.--', ax=axes[0,0], ylim=[0,50], xlim=[0,100])
df_fr1_scs15_10ms.plot(kind='line', style='.--', ax=axes[0,1], ylim=[0,50], xlim=[0,100])
df_fr1_scs15_20ms.plot(kind='line', style='.--', ax=axes[0,2], ylim=[0,50], xlim=[0,100])
...
fig1.suptitle('SSB Occupancy (%) for FR = 1, SCS = 15 kHz\nL = SSB Count in SSB Burst Set, p = SSB Periodicity')
...
df_fr1_scs30_5ms.plot(kind='line', style='.--', ax=axes[0,0], ylim=[0,50], xlim=[0,100])
df_fr1_scs30_10ms.plot(kind='line', style='.--', ax=axes[0,1], ylim=[0,50], xlim=[0,100])
df_fr1_scs30_20ms.plot(kind='line', style='.--', ax=axes[0,2], ylim=[0,50], xlim=[0,100])
...
fig2.suptitle('SSB Occupancy (%) for FR = 1, SCS = 30 kHz\nL = SSB Count in SSB Burst Set, p = SSB Periodicity')
...
df_fr2_scs120_5ms.plot(kind='line', style='.--', ax=axes[0,0], ylim=[0,50], xlim=[0,400])
df_fr2_scs120_10ms.plot(kind='line', style='.--', ax=axes[0,1], ylim=[0,50], xlim=[0,400])
df_fr2_scs120_20ms.plot(kind='line', style='.--', ax=axes[0,2], ylim=[0,50], xlim=[0,400])
...
fig3.suptitle('SSB Occupancy (%) for FR = 2, SCS = 120 kHz\nL = SSB Count in SSB Burst Set, p = SSB Periodicity')
